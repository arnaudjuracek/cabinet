...
module.exports = async function (url, {
  ...
  if (!reader.content) throw new Error('Cannot parse content for this URL')
  ...
  if (output) {
    ...
    article.uri = slugify(
      Render.interpolate(article, path.basename(output, ext)),
      // Handle articles with extension in their title, ie:
      // "How three.js changed my life"
      // not being slugged as :
      // "how-three.js changed my life"
